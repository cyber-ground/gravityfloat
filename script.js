...
// --------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// gravity version 5. mouse interactive floating popping balls --- 
...
let randomColor; 
const colors = ['#F2E635cf','#26211Dcf','#E11F1Fa3','#87cfeba3']; 
  const mouse = {x: undefined, y: undefined};
...
class Ball {
  ...
  eventHandler() {  // gravity switch to 0G
    canvas.addEventListener('click', (e) => {
      ...
      if(e.clientY < 100 && e.clientX < 100) {
        canvas.classList.remove('blank');
        this.gravity = 0;  // left // 0G
        this.dx = (Math.random() - 0.5) * 5;
        this.dy = (Math.random() - 0.5) * 5;
      } 
      if(e.clientY < 100  // middle // color switch on
        && e.clientX < canvas.width / 2 + 50 
        && e.clientX > canvas.width / 2 - 50) { 
  ...
  mouseColDetect() {
    ...
    if(distance - this.radius < 0) {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {this.color = randomColor}, 300);
    } 
...
function createBalls(gravity) {
  ...
  for (let i = 0; i < 60; i++) {  // SP 60 // PC 120 //
    ballArr.push(new Ball(
    randomMinMax(30, canvas.width - 30), 
...
// ------------------------------------------------------------------------------------------------
// gravity version 6. mouse interactive floating glow balls --- 


// const colors = ['#F2E635','#F2D43D','#F2E7AC','#333','#F2F2F2'];
...
//       canvas.height = innerHeight;
//     const mouse = {x: undefined, y: undefined};
//   let RANDOM_COLOR, DEFAULT_COLOR = '#940de2cf';
...
//       }, 0);
//     } 
//     // if(this.radius > 70)  // SP //
//     if(this.radius > 100)  // PC //
//       {this.radius = this.radius * 0.01} 
//     // if(this.radius > 10){this.radius -= 1}  // auto shrink
//   }
//   reposition() {
//     if(this.x + this.radius - 1 > canvas.width) {
//       this.x = canvas.width - this.radius;
...
//   const ballArr = [];
// function createBalls() {
//   for (let i = 0; i < 120; i++) {  // * shrink 920 
//     ballArr.push(new Ball(
//     randomMinMax(30, canvas.width - 30), 
//     randomMinMax(30, canvas.height - 30),  
...
// canvas.addEventListener('click', (e) => {
//   if(e.clientY < 100  // middle right // multiple color 
//     && e.clientX < canvas.width - 100 
//     && e.clientX > canvas.width / 2) { 
//     ballArr.splice(0);
//     createColorBalls();
//   }
//   if(e.clientY < 100 &&  // middle left // default color 
//     (e.clientX > 100 && e.clientX < canvas.width / 2)) {
//     ballArr.splice(0);
//     createBalls();
//   }
// });
